    ...
    <div className="min-h-[calc(100vh-180px)] flex flex-col">
      ...
      <section className="relative bg-gradient-to-br from-[hsl(var(--clr-surface-a0))] to-[hsl(var(--clr-surface-a20))] py-20 px-4 text-center">
        <div className="absolute inset-0 opacity-30" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ea384c' fill-opacity='0.05'%3E%3Ccircle cx='30' cy='30' r='4'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
        }}></div>
